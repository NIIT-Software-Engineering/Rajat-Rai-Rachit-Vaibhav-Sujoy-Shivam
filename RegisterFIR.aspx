<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="RegisterFIR.aspx.cs" Inherits="RegisterFIR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <asp:Panel ID="Panel1" runat="server" Height="216px" BackImageUrl="~/Image/green.JPG">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:Button ID="btnregister" runat="server" Text="Register FIR" OnClick="btnregister_Click" ValidationGroup="G1" /></td>
                <td>
