...
public partial class ChangeCitizenPassword : System.Web.UI.Page
{
   ...
   // string con = "Data Source=.;Initial Catalog=CrimeInvestigationDatabase1;Integrated Security=true";
    ...
    protected void changePassword_Click(object sender, EventArgs e)
    {
        ...
        if (txtpass.Text == txtpass1.Text)
        {
            ...
            SqlCommand cmd = new SqlCommand("Update Citizen2 set pass = '" + txtpass.Text + "' where username ='" + name + "'", SqlCon);
