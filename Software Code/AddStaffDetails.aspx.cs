...
public partial class AddStaffDetails : System.Web.UI.Page
{
   ...
   // SqlCommand cmd = null;
    ...
    protected void SignUpBtn_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into Staff2 values('" + txtName.Text + "','" + txtAge.Text + "','" + txtGender.Text + "','" + txtAddress.Text + "','" + txtPhone.Text + "','" + txtUserName.Text + "','" + txtPassword.Text + "')", SqlCon);
        SqlCon.Open();
        cmd.ExecuteNonQuery();
