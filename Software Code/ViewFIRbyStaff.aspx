<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMaster.master" AutoEventWireup="true" CodeFile="ViewFIRbyStaff.aspx.cs" Inherits="ViewFIRbyStaff" %>
     ...
     <asp:Panel ID="Panel1" runat="server" Height="298px">
        <table>
            ...
            <tr>
                <td>
                    <td>
                        <asp:Button ID="btnViewAll" runat="server"  Text="View All FIR" OnClick="btnViewAll_Click" />
                    </td>
                </td>
            </tr>
        </table>
