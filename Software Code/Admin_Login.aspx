...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table>
            <tr>
                 <td>
                     <asp:Label ID="Label" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="20pt" ForeColor="#000066" Text="Admin Login"></asp:Label>
                 </td>
            </tr>
           <tr>
           ...
           <tr>
            ...
            <tr>
                <td>
                    <asp:Button ID="login" runat="server" Font-Bold="True" OnClick="login_Click" Text="Login" ValidationGroup="G1" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
        ...
        <asp:Image ID="Image1" runat="server" width="500" Height="284" ImageUrl="~/images/login.png" />
    </asp:PlaceHolder>
    </asp:Panel>
