<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Staff_Login.aspx.cs" Inherits="Staff_Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <table>
            <tr>
                 <td>
                     <asp:Label ID="Label" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="20pt" ForeColor="#000066" Text="Staff Login"></asp:Label>
                 </td>
            </tr>
           <tr>
